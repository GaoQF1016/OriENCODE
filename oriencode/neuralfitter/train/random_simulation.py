...
def setup_random_simulation(param):
    ...
    prior_struct_unfocused = decode.simulation.structure_prior.RandomStructure_unfocused_around.parse(param)
    ...
    prior_train_unfocused = decode.simulation.emitter_generator.EmitterSamplerBlinking_unfocused.parse(
        param, structure=prior_struct_unfocused, frames=frame_range_train)
    ...
    simulation_train = decode.simulation.simulator.Simulation(psf=psf, em_sampler=prior_train, em_sampler_unfocused=prior_train_unfocused, background=bg,
    ...
    prior_test_unfocused = decode.simulation.emitter_generator.EmitterSamplerBlinking_unfocused.parse(
        param, structure=prior_struct_unfocused, frames=frame_range_test)
    
    simulation_test = decode.simulation.simulator.Simulation(psf=psf, em_sampler=prior_test, em_sampler_unfocused=prior_test_unfocused, background=bg, noise=noise,
